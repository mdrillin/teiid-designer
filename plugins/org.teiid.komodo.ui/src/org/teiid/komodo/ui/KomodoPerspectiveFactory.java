...
import org.teiid.komodo.ui.UiConstants.ExtensionPoints.KomodoPerspectiveContributorExtension;
import org.teiid.komodo.ui.UiConstants.Extensions;
import org.teiid.komodo.ui.util.PerspectiveObject;


/**
 * KomodoPerspectiveFactory
 *
 * @since 1.0
 */
public class KomodoPerspectiveFactory
implements Extensions, IPerspectiveFactory, KomodoPerspectiveContributorExtension {

    /** Array of all extensions to the KomodoPerspectiveContributor extension point */
    //private static List<IKomodoPerspectiveContributor> contributors;
     ...
     */
    public KomodoPerspectiveFactory() {
        super();
...
//        boolean oK = true;
//        Iterator<IKomodoPerspectiveContributor> iter = contributors.iterator();
//        IKomodoPerspectiveContributor helper = null;
...
//    }
    ...
    private Collection<PerspectiveObject> getViews(int viewLocationId, boolean isPrimary) {
        if( contributedPOs==null || contributedPOs.length == 0 )
...
//        contributors = new ArrayList<IKomodoPerspectiveContributor>();
//
...
//                        if ( contributor instanceof IKomodoPerspectiveContributor ) {
//                            contributors.add((IKomodoPerspectiveContributor)contributor);
//                        }
//                    }
//                }
//
